...
public class SpawnTest : MonoBehaviour
{
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        RoomTemplateSO roomTemplate = DungeonBuilder.Instance.GetRoomTeplate(roomChangedEventArgs.room.templateId);
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.T))
        {
            ...
            if (enemyDetails != null)
               instantiatedEnemyList.Add( Instantiate(enemyDetails.enemyPrefab, HelperUtilities.GetSpawnPositionToPlayer(HelperUtilities.GetMouseWorldPosition()), Quaternion.identity));
        }
    }
}